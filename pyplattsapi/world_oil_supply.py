...
def get_production_api_call(filter: str, field: str, groupBy: str, page: int = 1, scenarioTermId: int = 2):
    params = {
        'filter': filter,
    ...
    response = requests.get(url=production_api, headers=plattsapicore.build_header(api_name), params=params)
